...
export default function Bio() {
  return (
    <div className="min-h-[100svh] mx-4 mt-4">
      ...
      <div className="mt-4 sm:mt-8 max-w-3xl">
        ...
        <p className="mt-2 sm:text-2xl">
          Sams forte? Reading the vibe. His music isn&apos;t just background
          noise; it&apos;s an atmosphere enhancer, tailored to the energy of
          each event. His sensitivity and intuition transform gatherings into
          unforgettable experiences, where sophistication meets spontaneity.
        </p>
        <p className="mt-2 sm:text-2xl">
